...
function renderPago(obrero, monto){
  ...
  pagoImg.src = "https://jeronimoek.github.io/juegoIncremental/img/coin.png"
  pago.className = "pago"
...
function createTree(){
  ...
  if(treeRandom > 0.5){
    img.src = "https://jeronimoek.github.io/juegoIncremental/img/tree.png"
  } else {
    img.src = "https://jeronimoek.github.io/juegoIncremental/img/pink-tree.png"
  }
...
const createObrero = (function(){
  ...
  return function(){
    ...
    for(let i = 0; i < quant; i++){
      ...
      img.src = "https://jeronimoek.github.io/juegoIncremental/img/woodcutter.png"
